...
export default function Hero() {
  ...
  return (
    <section className="relative flex flex-col items-center justify-center min-h-screen px-6 pt-20 text-center overflow-hidden bg-black">
      ...
      <p className="max-w-3xl text-gray-300 text-lg md:text-xl mb-12 leading-relaxed font-light relative z-20">
      ...
      <p className="mt-6 text-sm text-gray-500 font-medium relative z-20">
