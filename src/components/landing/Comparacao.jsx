    ...
    <section className="relative bg-black border-t border-white/5 overflow-hidden -mt-20">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        ...
        <div className="relative max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-0 relative rounded-3xl overflow-hidden border border-white/10">
            
            {/* LADO ESQUERDO: O Padrão Antigo (Vermelho/Cinza) */}
            <div className="bg-white/[0.01] p-10 lg:p-14 lg:pr-20 lg:border-r border-white/5">
                <div className="mb-10 text-center lg:text-left">
                  <h3 className="text-2xl font-bold text-gray-300 mb-2 uppercase tracking-wide">
                    O Padrão Antigo
                  </h3>
                  ...
                  {comparativos.map((item, index) => (
                    <div key={index} className="flex flex-col gap-2">
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <span className="text-gray-400 font-light text-sm md:text-base leading-relaxed">
                          {item.tradicional}
                        </span>
                      </div>
                    </div>
            ...
            <div className="bg-gradient-to-b from-orange-500/10 to-transparent p-10 lg:p-14 lg:pl-20 relative overflow-hidden">
              {/* Brilho interno */}
              <div className="absolute top-0 right-0 w-64 h-64 bg-orange-500/10 blur-[80px] rounded-full pointer-events-none"></div>
                ...
                <div className="mb-10 text-center lg:text-left relative z-10">
                  <h3 className="text-2xl font-black text-white mb-2 uppercase tracking-wide flex items-center justify-center lg:justify-start gap-3">
                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-amber-300">
                      GearMind IA
                    </span>
                  </h3>
                  <p className="text-orange-500/70 text-sm font-light">
                ...
                <div className="space-y-8 relative z-10">
                  {comparativos.map((item, index) => (
                    <div key={index} className="flex flex-col gap-2">
                      <span className="text-[10px] font-bold text-orange-500/50 uppercase tracking-widest hidden lg:block">
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <span className="text-white font-medium text-sm md:text-base leading-relaxed drop-shadow-md">
                          {item.gearmind}
                        </span>
                      </div>
                    </div>
